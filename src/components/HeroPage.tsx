...
const HeroPage = () => {
  return (
    <>
      ...
      <div className="p-4 md:p-0 md:mt-[180px] md:ml-[150px] flex flex-col gap-5  md:gap-0 md:flex-row text-gray-dark  md:justify-center my-16">
        ...
        <div className="md:w-[1000px] px-20 md:px-0">
          <Image
            src={phone}
            alt=""
            className="w-[1000px] md:w-[1700px]"
          />
        </div>
      </div>
    </>
